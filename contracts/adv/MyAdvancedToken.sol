...
/**
* Стандартный ERC20 взятый с сайта Ethereum 
* (Возможно на первом этапе можно было бы обойтись и самым простым токеном)
*/
contract TokenERC20 {
...
contract MyAdvancedToken is owned, TokenERC20 {
    ...
    event ApproveAndCallAdvEvent(address _spender, uint256 _value, string _adv_text);
    ...
    function approveAndCallAdv(address _spender, uint256 _value, 
        ...
        public
        returns (bool success) {
        ApproveAndCallAdvEvent(_spender, _value, _adv_text);
